...
sleep(0.4)
ser.write(f"mdl_sched action-ctx-set 0x64 0xFFF 0 24 60 00 0x7F 1 {transition_time} 0\r\n".encode())
ser.write(f"mdl_sched action-set 0\r\n".encode())
sleep(0.4)
ser.write(f"mdl_sched action-ctx-set 0x64 0xFFF 0 24 60 15 0x7F 0 {transition_time} 0\r\n".encode())
ser.write(f"mdl_sched action-set 1\r\n".encode())
sleep(0.4)
ser.write(f"mdl_sched action-ctx-set 0x64 0xFFF 0 24 60 30 0x7F 1 {transition_time} 0\r\n".encode())
ser.write(f"mdl_sched action-set 2\r\n".encode())
sleep(0.4)
ser.write(f"mdl_sched action-ctx-set 0x64 0xFFF 0 24 60 45 0x7F 0 {transition_time} 0\r\n".encode())
